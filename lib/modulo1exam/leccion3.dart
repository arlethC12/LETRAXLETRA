...
import 'package:letra_x_letra/modulo1exam/leccion2.dart'; // ← Lección 2
import 'package:letra_x_letra/modulo1exam/leccion4.dart'; // ← Lección 4

void main() => runApp(const Leccion3());
...
class _WordGameScreenState extends State<WordGameScreen> {
  final String correctWord = "ABEJA";
  List<String?> userAnswer = List.filled(5, null);
  List<String> availableLetters = ['A', 'B', 'E', 'J', 'A', 'I', 'O', 'L', 'U'];
    ...
    if (!userAnswer.contains(null)) {
      ...
      if (guess == correctWord) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("¡Correcto! Excelente!"),
  ...
  // ← Verifica que la palabra sea correcta
            ...
            Padding(
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  double boxSize = (constraints.maxWidth - 40) / 5;
                  return Row(
  ...
  Color _getBoxColor(int index) {
    String? letter = userAnswer[index];
    if (letter == null) {
      return const Color.fromARGB(255, 253, 251, 251); // base
    }
