...
import 'dart:math';
// Importa la pantalla que ya has creado
import 'cargajaguar.dart'; // Ajusta esta ruta según la ubicación real de tu archivo cargajaguar.dart

void main() {
  runApp(NivelOgradoScreen());
}

class NivelOgradoScreen extends StatelessWidget {
  @override
          ...
          Center(
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  // Las estrellas ahora están justo encima del listón
                  Row(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      // Navegar a la pantalla CargarJaguar
                      Navigator.push(
                        context,
                        MaterialPageRoute(
