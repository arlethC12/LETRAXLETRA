...
void main() {
  runApp(BurbujaEScreen());
}

class BurbujaEScreen extends StatelessWidget {
  @override
...
class _BubbleScreenState extends State<BubbleScreen>
  ...
  void popBubble(int index) {
    if (bubbles[index].letter.toLowerCase() == 'e' &&
                    ...
                    child: Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          value: totalEs == 0 ? 0 : poppedEs / totalEs,
                    ...
                    return Positioned(
                      ...
                      child: GestureDetector(
                        ...
                        child: BubbleWidget(
                          ...
                          key: bubbles[i].key,
                          isPopping:
                              bubbles[i].letter.toLowerCase() == 'e' &&
                              !bubbles[i].isVisible,
                        ),
                      ),
                    );
            ...
            if (poppedEs == totalEs)
              Positioned(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    // Navega a la pantalla Nivel2Screen
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Nivel2Screen()),
                    );
                  },
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      ...
                      if (widget.letter.toLowerCase() == 'e')
                        BoxShadow(
