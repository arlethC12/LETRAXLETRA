...
import 'dart:math';
import 'package:letra_x_letra/vocalO/Nivel4.dart';
...
class BurbujaOScreen extends StatelessWidget {
  @override
...
class _BubbleScreenState extends State<BubbleScreen>
  ...
  Future<void> _playSound() async {
    try {
      await _audioPlayer.play(
        AssetSource('audios/VocalO/explota las burbujas (1).m4a'),
  ...
  void popBubble(int index) {
    if (bubbles[index].letter.toLowerCase() == 'o' &&
                    ...
                    child: Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          value: totalOs == 0 ? 0 : poppedOs / totalOs,
            ...
            Positioned(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text(
                    'Explota las burbujas de la letra o',
                    style: TextStyle(
                      fontSize: 16,
                    ...
                    return Positioned(
                      ...
                      child: GestureDetector(
                        ...
                        child: BubbleWidget(
                          ...
                          key: bubbles[i].key,
                          isPopping:
                              bubbles[i].letter.toLowerCase() == 'o' &&
                              !bubbles[i].isVisible,
                        ),
                      ),
                    );
              ...
              Positioned(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Nivel4Screen()),
                    );
                  },
